        ...
        if username.startswith("@"):
            try:
               ...
               if int(id) in RiZoeLX:
                   return await rizx.send_message("I can't raid on @SPA4KY")
